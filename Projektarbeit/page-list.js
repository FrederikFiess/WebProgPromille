 ...
 class PageList {
     ...
     _renderList() {
         ...
         data.forEach(dataset => {
             ...
             dummy.innerHTML = dummy.innerHTML.replace("$Name$", dataset.name);
             dummy.innerHTML = dummy.innerHTML.replace("$Menge$", dataset.menge);
             dummy.innerHTML = dummy.innerHTML.replace("$Alkohol$", dataset.alkohol);
             dummy.innerHTML = dummy.innerHTML.replace("$Beschreibung$", dataset.beschreibung);
     ...
     _askDelete(index) {
         ...
         let answer = confirm("Soll das ausgewählte Getränk wirklich gelöscht werden?");
         if (!answer) return;
